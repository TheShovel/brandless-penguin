...
const GUIComponent = (props) => {
  ...
  const getTabOrder = () => {
    const tabOrderStr =
      localStorage.getItem("pm:taborder") || '["code", "costume", "sound"]';
  ...
  const ContextMenuWrapTab = ({ children, ...props }) => {
    ...
    return (
      <>
        <ContextMenuTrigger
          disable={disabled}
          id={`remove-editor-tab-${tabId}`}
        >
          {children}
        </ContextMenuTrigger>
        {ReactDOM.createPortal(
          <ContextMenu id={`remove-editor-tab-${tabId}`}>
  ...
  const codeTab = (
    <Tab
      className={classNames(
        tabClassNames.tab,
        tabOrder.includes("code") ? null : styles.tabDisabled,
      )}
    >
  ...
  const costumesTab = (
    <Tab
      className={classNames(
        tabClassNames.tab,
        tabOrder.includes("costume") ? null : styles.tabDisabled,
      )}
  ...
  const soundsTab = (
    <Tab
      className={classNames(
        tabClassNames.tab,
        tabOrder.includes("sound") ? null : styles.tabDisabled,
      )}
  ...
  const variablesTab = (
    <Tab
      className={classNames(
        tabClassNames.tab,
        tabOrder.includes("variable") ? null : styles.tabDisabled,
      )}
      onClick={onActivateVariablesTab}
    >
      <ContextMenuWrapTab tabId="variable">
        <img draggable={false} src={variablesIcon} />
        <FormattedMessage
  ...
  const filesTab = (
    <Tab
      className={classNames(
        tabClassNames.tab,
        tabOrder.includes("file") ? null : styles.tabDisabled,
      )}
      onClick={onActivateFilesTab}
    >
      <ContextMenuWrapTab tabId="file">
        <img draggable={false} src={filesIcon} />
        <FormattedMessage
  ...
  const minWidth =
    layout.fullSizeMinWidth +
    Math.max(0, customStageSize.width - layout.referenceWidth);
  return (
          ...
          >
            ...
            {isCreating ? (
              <Loader
                isFullScreen
                messageId={
                  isPlayground ? "gui.loader.playground" : "gui.loader.creating"
                }
              />
            ) : null}
            ...
            <Box
              className={classNames(
                styles.bodyWrapper,
                isPlayground ? styles.bodyWrapperPlayground : null,
              )}
            >
                        ...
                        <button
                          className={classNames(
                            ...
                            addTabButtonDisabled
                              ? styles.addTabButtonDisabled
                              : null,
                          )}
                        >
                          <img draggable={false} src={plusIcon} />
                        </button>
                      </ContextMenuTrigger>

                      <ContextMenu id={`add-editor-tab-button`}>
                        {!tabOrder.includes("code") && (
                          <MenuItem onClick={() => addTabToEditor("code")}>
                        ...
                        {!tabOrder.includes("costume") && (
                          <MenuItem onClick={() => addTabToEditor("costume")}>
                            <div className={styles.tabAdditionItem}>
                              <img draggable={false} src={costumesIcon} />
                              <FormattedMessage
                                defaultMessage="Costumes"
                        ...
                        {!tabOrder.includes("sound") && (
                          <MenuItem onClick={() => addTabToEditor("sound")}>
                            <div className={styles.tabAdditionItem}>
                              <img draggable={false} src={soundsIcon} />
                              <FormattedMessage
                                defaultMessage="Sounds"
                        ...
                        {!tabOrder.includes("variable") && (
                          <MenuItem onClick={() => addTabToEditor("variable")}>
                            <div className={styles.tabAdditionItem}>
                              <img draggable={false} src={variablesIcon} />
                              <FormattedMessage
                                defaultMessage="Variables"
