  ...
  <div className={styles.colorPickerArea}>
    ...
    <div>
      ...
      <div className={styles.parentCustom}>
        ...
        />
        <img src={dropperIcon} className={styles.customPlus} />
      </div>
    </div>
  </div>
);
  ...
  >
    ...
    <Box className={styles.body}>
      <div className={styles.optionsRow}>
        ...
        >
          <img className={styles.optionIcon} src={stackBlockIcon} />
          <div className={styles.optionTitle}>
            <FormattedMessage
              defaultMessage="Add an input"
      ...
      {!props.editing && (
        <div className={styles.optionsRow} style={{ marginTop: "1em" }}>
          {props.returns ? (
            <>
              <div
                className={styles.optionCard}
              ...
              >
                <img className={styles.optionIcon} src={reporterBlockIcon} />
                <div className={styles.optionTitle}>
                  <FormattedMessage
            ...
            <>
              ...
              >
                <img className={styles.optionIcon} src={terminalBlockIcon} />
                <div className={styles.optionTitle}>
                  <FormattedMessage
          ...
          {props.returns && (
            ...
            >
              <img className={styles.optionIcon} src={booleanBlockIcon} />
              <div className={styles.optionTitle}>
                <FormattedMessage
