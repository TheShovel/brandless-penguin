...
class MenuBar extends React.Component {
  ...
  handleClickMode(effect) {
    ...
    switch (effect) {
      case "night":
        body.style.filter =
          "brightness(90%) sepia(100%) hue-rotate(340deg) saturate(400%)";
        break;
      case "blur":
        ...
        <div className={styles.mainMenu}>
          <div className={styles.fileGroup}>
            ...
            {this.props.onClickTheme && (
              ...
              >
                <img src={themeIcon} width="24" height="24" draggable={false} />
              </div>
            )}
              ...
              <div>
                ...
                >
                  <div className={classNames(styles.errorsMenu)}>
                    <img className={styles.languageIcon} src={errorIcon} />
                ...
                <MenuSection>
                  ...
                  <ChangeUsername>
                    {(changeUsername) => (
                      <MenuItem
                        className={classNames({
                          [styles.disabled]: this.props.usernameLoggedIn,
                        })}
                        onClick={
...
MenuBar.propTypes = {
  ...
  className: PropTypes.string,
  compileErrors: PropTypes.arrayOf(
    PropTypes.shape({
