  ...
  <footer className={styles.footer}>
    <div className={styles.footerContent}>
      ...
      <div className={styles.footerColumns}>
        ...
        <div className={styles.footerSection}>
          <a href="packager-app/index.html">
            {/* Do not translate */}
            {"PenguinMod Packager"}
          </a>
...
class Interface extends React.Component {
  ...
  render() {
    ...
    const projectReleaseMonth =
      monthNames[extraProjectInfo.releaseDate.getMonth()];
    const projectReleaseDay = addNumberSuffix(
      extraProjectInfo.releaseDate.getDate(),
    );
    const projectReleaseHour =
      (extraProjectInfo.releaseDate.getHours() % 12) + 1;
    const projectReleaseHalf =
      extraProjectInfo.releaseDate.getHours() > 11 ? "PM" : "AM";
      ...
      >
        ...
        >
          {isHomepage && announcement ? (
            <DOMElementRenderer domElement={announcement} />
          ) : null}
          {isHomepage &&
            projectId !== "0" &&
            title &&
            ...
            <React.Fragment>
              ...
              {!extraProjectInfo.accepted && (
                <div className={styles.remixWarningBox}>
                  <p>
                    This project is currently under review. Content may not be
                    suitable for all ages, and you should be careful when
                    running the project.
                  </p>
                </div>
              )}
              ...
              {extraProjectInfo.author && (
                <VoteFrame id={projectId} darkmode={this.props.isDark} />
              )}
