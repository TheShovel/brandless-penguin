...
const menuItems = [
  ...
  },
  {
    ...
    iconURL:
      "https://extensions.penguinmod.com/images/ObviousAlexC/PenPlus.svg",
    description:
      "An extension to the Pen category! Adds blocks for drawing triangles using textures and tints, drawing images and editing their pixels, etc.",
    featured: true,
  ...
  },
  {
    name: "Sound Waves",
    extensionId:
      "https://extensions.penguinmod.com/extensions/SharkPool/Sound-Waves.js",
    iconURL:
      "https://extensions.penguinmod.com/images/SharkPool/Sound-Waves.svg",
  ...
  },
  {
    ...
    tags: ["penguinmod", "categoryexpansion"],
    description:
      "More events for sending & receiving information, notifing specific sprites or better control when things should happen.",
    featured: true,
  ...
  },
  {
    ...
    tags: ["penguinmod", "categoryexpansion"],
    description:
      "More control blocks for animations, complex systems or cleaner one-time use blocks.",
    featured: true,
  ...
  },
  {
    ...
    description:
      "Customize the appearance of variable monitors and prompts in your project.",
  ...
  },
  {
    ...
    description:
      "Have sprites & clones follow behind other sprites & clones by an offset, like RPG party members.",
  ...
  },
  {
    name: "Tile Grids",
    extensionId:
      "https://extensions.penguinmod.com/extensions/SharkPool/Tile-Grids.js",
    iconURL:
      "https://extensions.penguinmod.com/images/SharkPool/Tile-Grids.svg",
    tags: ["penguinmod"],
  ...
  },
  {
    ...
    insetIconURL: turbowarpIcon,
    description:
      "Have your sprites show themselves as other images or costumes.",
    featured: true,
    twDeveloper: "LilyMakesThings",
  },
  {
  ...
  },
  {
    name: "Font Manager",
    extensionId:
      "https://extensions.penguinmod.com/extensions/SharkPool/Font-Manager.js",
    iconURL:
      "https://extensions.penguinmod.com/images/SharkPool/Font-Manager.svg",
    tags: ["penguinmod", "graphics"],
  ...
  },
  {
    ...
    tags: ["turbowarp"],
    description:
      "Comprehensive extension for interacting with external websites.",
    featured: true,
    internetConnectionRequired: true,
  ...
  },
  {
    name: "CloudLink",
    extensionId:
      "https://extensions.penguinmod.com/extensions/MikeDev101/cloudlink.js",
    tags: ["turbowarp", "penguinmod"],
    insetIconURL: cloudlinkIcon,
    iconURL:
      "https://extensions.penguinmod.com/images/MikeDev101/cloudlink.svg",
  ...
  },
  {
    ...
    tags: ["penguinmod", "datamgmt"],
    description:
      "Create compiled scripts with blocks while the project is running.",
    featured: true,
  },
  {
    name: "Pang API",
    extensionId:
      "https://extensions.penguinmod.com/extensions/SammerLOL/pangapi.js",
  ...
  },
  {
    name: "3D Math",
    extensionId:
      "https://extensions.penguinmod.com/extensions/ObviousAlexC/3DMath.js",
    iconURL: "https://extensions.penguinmod.com/images/ObviousAlexC/3DMath.svg",
    tags: ["penguinmod", "3d", "graphics"],
    description:
      "A handful of utilities for making your own sprite-based 3D engine.",
    extDeveloper: "pinksheep2917",
    featured: true,
  },
  {
    ...
    extensionId:
      "https://extensions.penguinmod.com/extensions/jwklong/mathematics.js",
  ...
  },
  {
    ...
    extensionId:
      "https://extensions.penguinmod.com/extensions/Gen1x/random_utils.js",
    iconURL: "https://extensions.penguinmod.com/images/Gen1x/randomutils.png",
    tags: ["penguinmod"],
    description:
      "Many blocks related to generating random values, including seed-based number generation, true number generation, UUID's, random strings, etc.",
    extDeveloper: "G1nX",
    featured: true,
  },
  {
  ...
  },
  {
    name: "PenguinAI",
    extensionId:
      "https://extensions.penguinmod.com/extensions/MubiLop/penguingpt.js",
    iconURL: "https://extensions.penguinmod.com/images/MubiLop/penguingpt.png",
    tags: ["penguinmod"],
    description:
      "Talk to AI! Use Models like DALL-E-3, GPT, LLama, Claude, and more! Please read PenguinMod's Privacy Policy before use.",
  ...
  },
  {
    ...
    tags: ["penguinmod"],
    description:
      "Allow the user to choose a color using the built-in color picker, so you don't need to make your own.",
    extDeveloper: "TheShovel",
    featured: true,
  },
  {
  ...
  },
  {
    name: "All Menus",
    extensionId:
      "https://extensions.penguinmod.com/extensions/Lily/AllMenus.js",
  ...
  },
  {
    ...
    description:
      "Allows you to show a dialog for printing text, images, and custom HTML to a printer.",
    featured: true,
  },
  {
  ...
  },
  {
    ...
    description:
      "Publicly available developer branch, with the latest features.",
    credits: "Started by JeremyGamer13, continued by jwklong",
    tags: ["extcreate"],
    featured: true,
  },
...
if (IsLocal || IsLiveTests) {
  const extras = [
    ...
    },
    {
      ...
      tags: ["penguinmod", "datamgmt"],
      description:
        "Basic blocks for files. This has been replaced by the TurboWarp files extension.",
      featured: true,
    },
    {
      ...
      tags: ["penguinmod"],
      description:
        "Mainly sharing data between clones and the main sprite, but also some other small features. This has been replaced by the TurboWarp Clones+ extension.",
      featured: true,
    },
    {
      name: "Easy Save",
      ...
      tags: ["penguinmod", "datamgmt"],
      description:
        "Save variables, lists and extra info to a file, then load those things back in.",
      featured: true,
    },
    {
      name: (
    ...
    },
    {
      ...
      iconURL:
        "https://extensions.penguinmod.com/images/JeremyGamer13/christmas.png",
      tags: ["penguinmod", "joke"],
      description: "hooraye",
      featured: true,
    },
    {
      ...
      iconURL:
        "https://extensions.penguinmod.com/images/JeremyGamer13/epic.png",
      internetConnectionRequired: true,
      tags: ["penguinmod", "joke"],
    ...
    },
    {
      name: "Epic utilities",
      extensionId:
        "https://extensions.penguinmod.com/extensions/SharkPool/AprilFools.js",
      iconURL:
        "https://extensions.penguinmod.com/images/JeremyGamer13/epicutils.png",
      tags: ["penguinmod", "joke"],
      description:
        "the super good utilities brought to you by todays sponsor sharkpool (the epic utilities)",
      featured: true,
    },
    {
      name: "image blocks",
      extensionId:
        "https://extensions.penguinmod.com/extensions/Ashime/funneimageblocks.js",
      iconURL:
        "https://extensions.penguinmod.com/images/JeremyGamer13/screenshot1.png",
      tags: ["penguinmod", "joke"],
      internetConnectionRequired: true,
    ...
    },
    {
      ...
      extensionId:
        "https://extensions.penguinmod.com/extensions/JeremyGamer13/FireInTheHole.js",
      iconURL: "https://library.penguinmod.com/files/emojis/cluelesssmile.png",
      tags: ["penguinmod", "joke"],
      internetConnectionRequired: true,
      description:
        "april fools took too long man this joke is not funny anymore",
      featured: true,
    },
    {
      name: "Unite",
      ...
      tags: ["penguinmod"],
      description:
        "Legacy extension that was eventually merged into the default toolbox.",
      featured: true,
    },
    {
      name: "XML",
      ...
      tags: ["penguinmod", "datamgmt"],
      description:
        "Enables the creation and getting of XML data. Not yet able to modify data.",
      extDeveloper: "jwklong",
      featured: true,
    },
    {
      ...
      tags: ["penguinmod"],
      description:
        "Log information and run commands. Good for debugging packaged projects or just easily changing things.",
      featured: true,
    },
    {
    ...
    },
    {
      ...
      iconURL: penguinmodLibraryExtensionIcon,
      description:
        "Opens the editor with this tab as the parent, still with the library opened. For developers.",
      featured: true,
    },
    {
      name: (
    ...
    },
    {
      ...
      tags: ["penguinmod"],
      description:
        "Legacy extension, old blocks no longer serve a real purpose. Direct blocks to manage permissions that PenguinMod requires you have to do certain tasks.",
      featured: true,
    },
    {
      ...
      tags: ["penguinmod"],
      description:
        "Test extension to see if things are possible.\nDO NOT USE THIS IN PRODUCTION as blocks are subject to change and may corrupt your projects.",
      credits:
        "Some features added from LilyMakesThings, CubesterYT, TheShovel",
      featured: true,
    },
    {
      name: "3D",
    ...
    },
    {
      ...
      description:
        "In development. May break compatibility. Allow players to really jump into your world!",
      featured: true,
    },
    {
      name: "Interfaces",
    ...
    },
    {
      ...
      description:
        "In development. Do extra things in packaged applications that you can't do in the website!",
      featured: true,
    },
