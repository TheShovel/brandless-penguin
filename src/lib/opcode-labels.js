...
const messages = defineMessages({
  ...
  looks_getEffectValue: {
    ...
    description:
      "Label for the effect monitor with no effect chosen when shown on the stage",
  ...
  looks_getEffectValue_pixelate: {
    ...
    description:
      "Label for the pixelate effect monitor when shown on the stage",
  ...
  looks_getEffectValue_brightness: {
    ...
    description:
      "Label for the brightness effect monitor when shown on the stage",
  ...
  looks_getEffectValue_saturation: {
    ...
    description:
      "Label for the saturation effect monitor when shown on the stage",
  ...
  sound_getEffectValue: {
    defaultMessage: "effect",
    description:
      "Label for the sound effect monitor with no effect chosen when shown on the stage",
  ...
  sound_getEffectValue_pan: {
    ...
    description:
      "Label for the pan left/right effect monitor when shown on the stage",
  ...
  sensing_dayssince2000: {
    ...
    description:
      "Label for the days since 2000 monitor when shown on the stage",
...
class OpcodeLabels {
  ...
  _refreshOpcodeMap() {
    ...
    this._opcodeMap.looks_stretchGetX.labelFn = () =>
      this._translator(messages.looks_stretchGetX);
    this._opcodeMap.looks_stretchGetY.labelFn = () =>
      this._translator(messages.looks_stretchGetY);
    this._opcodeMap.looks_sayWidth.labelFn = () =>
      this._translator(messages.looks_sayWidth);
    this._opcodeMap.looks_sayHeight.labelFn = () =>
      this._translator(messages.looks_sayHeight);
    ...
    this._opcodeMap.looks_tintColor.labelFn = () =>
      this._translator(messages.looks_tintColor);
    this._opcodeMap.looks_getSpriteVisible.labelFn = () =>
      this._translator(messages.looks_getSpriteVisible);
    this._opcodeMap.looks_layersGetLayer.labelFn = () =>
      this._translator(messages.looks_layersGetLayer);
    ...
    this._opcodeMap.sensing_mouseclicked.labelFn = () =>
      this._translator(messages.sensing_mouseclicked);
    ...
    this._opcodeMap.sensing_getclipboard.labelFn = () =>
      this._translator(messages.sensing_getclipboard);
    this._opcodeMap.sensing_getdragmode.labelFn = () =>
      this._translator(messages.sensing_getdragmode);
    this._opcodeMap.sensing_loud.labelFn = () =>
      this._translator(messages.sensing_loud);
    this._opcodeMap.sensing_dayssince2000.labelFn = () =>
      this._translator(messages.sensing_dayssince2000);
    this._opcodeMap.sensing_loggedin.labelFn = () =>
      this._translator(messages.sensing_loggedin);

    // Control
    this._opcodeMap.control_get_counter.labelFn = () =>
      this._translator(messages.control_get_counter);
  }
